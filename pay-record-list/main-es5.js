...
module.exports = "<div class=\"summarydisplay\">\n    <div class=\"summarydisplay__content\">\n        <div class=\"summarydisplay__content__item-one\">\n            <div>\n                <span class=\"summarydisplay__content__item-one--month\">{{currentDataSummary.month}}</span>/{{currentDataSummary.year}}\n            </div>\n            <div class=\"summarydisplay__content__item-one--remaining-money\">余额：<img src=\"/angulardemo/pay-record-list/assets/img/icon/rmb2.svg\" alt=\"\">{{currentDataSummary.remainingMoney}}</div>\n        </div>\n        <div class=\"summarydisplay__content__item-two\">\n            <div class=\"summarydisplay__content__item-two--icon\">\n                <img src=\"/angulardemo/pay-record-list/assets/img/icon/i.svg\" alt=\"\">\n            </div>\n            <div class=\"summarydisplay__content__item-two--content\">\n                <div class=\"summarydisplay__content__item-two--item\">\n                    <span>支出</span>\n                    <br>\n                    <span class=\"summarydisplay__content__item-two--val\"><img src=\"/angulardemo/pay-record-list/assets/img/icon/rmb.svg\" alt=\"\">{{currentDataSummary.spendingMoney}}</span>\n                </div>\n                <div class=\"summarydisplay__content__item-two--item\">\n                    <span>收入</span>\n                    <br>                    \n                    <span class=\"summarydisplay__content__item-two--val\"><img src=\"/angulardemo/pay-record-list/assets/img/icon/rmb.svg\" alt=\"\">{{currentDataSummary.incomeMoney}}</span>\n                </div>\n            </div>\n        </div>\n        <div class=\"summarydisplay__content__item-three\">\n            <span>预算</span><span class=\"summarydisplay__content__item-three--set\">您还未设置<img src=\"/angulardemo/pay-record-list/assets/img/icon/ico-right-arrow.svg\" alt=\"\"></span>            \n        </div>\n    </div>\n</div>\n"
...
var IncomeSpendAnalysisComponent = /** @class */ (function () {
    function IncomeSpendAnalysisComponent() {
        this.title = '收支分析';
    }
    IncomeSpendAnalysisComponent.prototype.ngOnInit = function () {
    };
    ...
    return IncomeSpendAnalysisComponent;
}());
...
var IncomeSpendComponent = /** @class */ (function () {
    function IncomeSpendComponent(dataService) {
        var _this = this;
        this.dataService = dataService;
        this.title = '收支';
        this.monthIndex = 0;
        this.dataService.getUserInfo().subscribe(function (data) {
            _this.userInfo = data;
            _this.setData(_this.monthIndex);
        });
    }
    IncomeSpendComponent.prototype.setData = function (monthIndex) {
        var _this = this;
        if (this.userInfo && (this.userInfo.remainingMoney != undefined) && this.userInfo.payingDetail && this.userInfo.payingDetail.yearList && this.userInfo.payingDetail.yearList[0] && this.userInfo.payingDetail.yearList[0].certainYear && this.userInfo.payingDetail.yearList[0].monthList && this.userInfo.payingDetail.yearList[0].monthList[monthIndex] && this.userInfo.payingDetail.yearList[0].monthList[monthIndex].certainMonthShort && (this.userInfo.payingDetail.yearList[0].monthList[monthIndex].spendingMoney != undefined) && (this.userInfo.payingDetail.yearList[0].monthList[monthIndex].incomeMoney != undefined)) {
            this.monthList = [];
            this.userInfo.payingDetail.yearList[0].monthList.map(function (item) {
                _this.monthList.push(item.certainMonth);
            });
            this.dataSummary = {
    ...
    IncomeSpendComponent.prototype.ngOnInit = function () {
    };
    IncomeSpendComponent.prototype.changeMonthHandler = function (index) {
        this.monthIndex = index;
        this.setData(this.monthIndex);
    };
    IncomeSpendComponent.ctorParameters = function () { return [
...
var MonthBillComponent = /** @class */ (function () {
    function MonthBillComponent() {
        this.title = '月度账单';
    }
    MonthBillComponent.prototype.ngOnInit = function () {
    };
...
var MyBillbookComponent = /** @class */ (function () {
    function MyBillbookComponent() {
        this.title = '我的账本';
    }
    MyBillbookComponent.prototype.ngOnInit = function () {
    };
...
var PayingDetailListComponent = /** @class */ (function () {
    function PayingDetailListComponent() {
    ...
    PayingDetailListComponent.prototype.ngOnInit = function () {
    };
    PayingDetailListComponent.prototype.ngOnChanges = function (changes) {
    ...
    return PayingDetailListComponent;
}());
...
var SearchTransactionComponent = /** @class */ (function () {
    function SearchTransactionComponent() {
        this.title = '查找交易';
    }
...
var SubnavbarComponent = /** @class */ (function () {
    ...
    SubnavbarComponent.prototype.ngOnInit = function () {
    };
    SubnavbarComponent.prototype.ngOnChanges = function (changes) {
        if (changes['monthList'] != undefined && changes['monthList'].currentValue) {
            this.currentMonthList = changes['monthList'].currentValue;
        }
    };
    SubnavbarComponent.prototype.toggleMonthActiveState = function () {
        this.monthActiveState = !this.monthActiveState;
    };
    SubnavbarComponent.prototype.toggleAccountActiveState = function () {
        this.accountActiveState = !this.accountActiveState;
    };
    SubnavbarComponent.prototype.changeMonth = function (index) {
        if (index !== this.monthIndex) {
            this.changeMonthHandler.emit(index);
        }
        this.monthActiveState = !this.monthActiveState;
    };
    SubnavbarComponent.prototype.changeAccount = function () {
        this.accountActiveState = !this.accountActiveState;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var SummaryDisplayComponent = /** @class */ (function () {
    function SummaryDisplayComponent() {
    ...
    SummaryDisplayComponent.prototype.ngOnInit = function () {
    };
    SummaryDisplayComponent.prototype.ngOnChanges = function (changes) {
    ...
    return SummaryDisplayComponent;
}());
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.urlPath = '/angulardemo/pay-record-list/assets/js/user.json';
    }
